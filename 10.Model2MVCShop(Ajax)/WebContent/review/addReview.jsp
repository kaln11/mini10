		 ...
		 $(function() {
			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
			 $( "button:contains('작성완료')" ).on("click" , function() {
				 $("form").attr("method" , "GET").attr("action" , "/review/addReview").submit();
				});
...
<input type="hidden" name="reprod.prodNo" value="${product.prodNo}">
	...
	<div class="container">
        ...
        <div><input type="text" class="kv-fa rating-loading" name="score" data-size="md" title=""></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">  <textarea  rows="5" class="form-control" id="epil" name="epil" ></textarea></div>
		</div>
			<hr/>
