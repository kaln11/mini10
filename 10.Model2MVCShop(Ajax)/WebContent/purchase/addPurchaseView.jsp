	...
	<script type="text/javascript">
	 ...
	 $(function() {	
		 ...
		 $('div[role="group"] button:nth-child(1)').on('click',function(){
			 ...
			 $("input[name='paymentOption']").val($('div[role="group"] button:nth-child(1)').val());
		  ...
		  $('div[role="group"] button:nth-child(2)').on('click',function(){
			  ...
			  $("input[name='paymentOption']").val($('div[role="group"] button:nth-child(2)').val());
		 }); 
...
<button class="btn btn-primary"  value="2" type="button">
  신용구매
		   ...
		   <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="receiverName" name="receiverName" value="${user.userName}" placeholder="${user.userName}" >
		    </div>
		  </div>
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="receiverPhone" name="receiverPhone" value="${(user.phone==null)?'000-0000-0000':user.phone}" placeholder="${(user.phone==null)?'000-0000-0000':user.phone}" >
		    </div>
		  </div>
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="receiverAddr" name="receiverAddr" value="${(user.addr==null)?'없음':user.addr}" placeholder="${(user.addr==null)?'없음':user.addr}" >
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4" >
		      <textarea  rows="5" class="form-control" id="dlvyRequest" name="dlvyRequest" ></textarea>
